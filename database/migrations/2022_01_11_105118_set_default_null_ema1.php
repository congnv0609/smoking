...
class SetDefaultNullEma1 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('ema1s', function (Blueprint $table) {
            ...
            $table->integer('s1')->nullable()->default(NULL)->change();
            $table->integer('s2')->nullable()->default(NULL)->change();
            $table->integer('s3')->nullable()->default(NULL)->change();
            $table->integer('s4')->nullable()->default(NULL)->change();
