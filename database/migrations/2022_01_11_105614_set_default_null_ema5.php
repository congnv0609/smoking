...
class SetDefaultNullEma5 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('ema5s', function (Blueprint $table) {
            ...
            $table->boolean('d1_a')->nullable()->default(NULL)->change();
            $table->boolean('d1_b')->nullable()->default(NULL)->change();
            $table->boolean('d1_c')->nullable()->default(NULL)->change();

            $table->boolean('p1_a')->nullable()->default(NULL)->change();
            $table->boolean('p1_b')->nullable()->default(NULL)->change();
            $table->boolean('p1_c')->nullable()->default(NULL)->change();
            $table->boolean('p1_d')->nullable()->default(NULL)->change();

            $table->boolean('p2_a')->nullable()->default(NULL)->change();
            $table->boolean('p2_b')->nullable()->default(NULL)->change();
            $table->boolean('p2_c')->nullable()->default(NULL)->change();
            $table->boolean('p2_d')->nullable()->default(NULL)->change();
