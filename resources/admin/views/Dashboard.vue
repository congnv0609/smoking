...
export default {
  ...
  data () {
    return {
      ...
      tableItems: [
        {
          avatar: { url: 'images/img/avatars/1.jpg', status: 'success' },
        ...
        {
          avatar: { url: 'images/img/avatars/2.jpg', status: 'danger' },
        ...
        {
          avatar: { url: 'images/img/avatars/3.jpg', status: 'warning' },
        ...
        {
          avatar: { url: 'images/img/avatars/4.jpg', status: '' },
        ...
        {
          avatar: { url: 'images/img/avatars/5.jpg', status: 'success' },
        ...
        {
          avatar: { url: 'images/img/avatars/6.jpg', status: 'danger' },
